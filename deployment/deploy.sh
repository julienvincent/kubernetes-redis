...
envsubst < deployment/Standalone.yml > _Standalone.yml
envsubst < deployment/StandaloneService.yml > _StandaloneService.yml

sudo /opt/google-cloud-sdk/bin/kubectl apply -f _StandaloneService.yml --record
sudo /opt/google-cloud-sdk/bin/kubectl apply -f _Standalone.yml --record